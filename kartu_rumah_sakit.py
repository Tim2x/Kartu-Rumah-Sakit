...
import mysql.connector
from periksa_kondisi_widget import PeriksaKondisi
from hasil_pemeriksaan_widget import HasilPemeriksaanWidget
from cetak_hasil_pemeriksaan_widget import CetakHasilPemeriksaanWidget
...
"")
    ...
    def init_periksa_kondisi(self):
        self.periksa_kondisi_widget = PeriksaKondisi(QWidget)
    ...
    def show_hasil_pemeriksaan(self):
        CetakHasilPemeriksaan = CetakHasilPemeriksaanWidget
    ...
    # Handle the result if needed
        ...
        # Perform actions upon accepting the dialog, if needed
            cetak_widget = CetakHasilPemeriksaan({'nama': nama_pasien, 'hasil_pemeriksaan': 'contoh hasil', 'obat': 'contoh obat'})
            cetak_widget.exec_()
        else:
